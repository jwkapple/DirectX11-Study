...
bool ModelClass::Initialize(ID3D11Device* device,ID3D11DeviceContext* deviceContext,char* modelFileName,const wchar_t** textureFileName)
{
	bool result = true;
...
{
	return mTexture->GetTextureArray();
}
