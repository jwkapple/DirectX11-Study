...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	...
	// DXGI_FORMATR_R8G8B8A8_UNORM 모니터 출력 디스플레이 포맷에 맞는 모드의 개수를 구합니다.
	...
	// 적합한 것을 찾으면 모니터의 새로고침 비율의 분모와 부자 값을 저장합니다.
	...
	// 어댑터(그래픽카드)의 description를 가져옵니다.
	...
	// description을 사용하여 깊이 버퍼와 스텐실 버퍼를 생성합니다.
	...
	// 렌더타겟 뷰와 깊이-스텐실 뷰를 각각 출력 파이프라인에 바인딩합니다.
	...
	// Clear the second depth stencil state before the parameters.
