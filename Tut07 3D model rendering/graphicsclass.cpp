...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(),m_D3D->GetDeviceContext(),(char*)"../Tut07 3D Model Rendering/Data/Cube.txt", (char*)"../Tut07 3D Model Rendering/Data/stone01.tga");
	if (!result)
	{
