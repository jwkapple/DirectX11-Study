...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	texturenames[0] = L"../Tut18 Light Map/Data/stone01.dds";
	texturenames[1] = L"../Tut18 Light Map/Data/light01.dds";

	result = m_Model->Initialize(m_D3D->GetDevice(),m_D3D->GetDeviceContext(),(char*)"../Tut18 Light Map/Data/Cube.txt",texturenames );
	if (!result)
	{
