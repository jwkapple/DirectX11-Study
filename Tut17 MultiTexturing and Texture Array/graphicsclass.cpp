...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	texturenames[0] = L"../Tut17 MultiTexturing and Texture Array/Data/stone01.dds";
	texturenames[1] = L"../Tut17 MultiTexturing and Texture Array/Data/dirt01.dds";

	result = m_Model->Initialize(m_D3D->GetDevice(),m_D3D->GetDeviceContext(),(char*)"../Tut17 MultiTexturing and Texture Array/Data/Cube.txt",texturenames );
	if (!result)
	{
