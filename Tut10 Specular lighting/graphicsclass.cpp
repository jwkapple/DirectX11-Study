...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(),m_D3D->GetDeviceContext(),(char*)"../Tut10 Specular lighting/Data/Cube.txt", (char*)"../Tut10 Specular lighting/Data/stone01.tga");
	if (!result)
	{
	...
	if (!result)
	{
		MessageBox(hwnd, (LPCSTR)"Could not initialize the shader obejct", (LPCSTR)"Error", MB_OK);
		return false;
	}
	...
	m_Light->SetSpecularPower(15.0f);
	return true;
}
